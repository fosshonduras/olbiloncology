...
export class BedsClient {
    ...
    search(searchTerm: string | null | undefined): Observable<BedsListModel | null> {
    ...
    protected processSearch(response: HttpResponseBase): Observable<BedsListModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class BuildingsClient {
    ...
    search(searchTerm: string | null | undefined): Observable<BuildingsListModel | null> {
    ...
    protected processSearch(response: HttpResponseBase): Observable<BuildingsListModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class HealthProfessionalsClient {
    ...
    search(searchTerm: string | null | undefined): Observable<HealthProfessionalsListModel | null> {
    ...
    protected processSearch(response: HttpResponseBase): Observable<HealthProfessionalsListModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class HospitalUnitsClient {
    ...
    search(searchTerm: string | null | undefined): Observable<HospitalUnitsListModel | null> {
    ...
    protected processSearch(response: HttpResponseBase): Observable<HospitalUnitsListModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class OncologyPatientsClient {
    ...
    search(searchTerm: string | null | undefined): Observable<OncologyPatientsListModel | null> {
    ...
    protected processSearch(response: HttpResponseBase): Observable<OncologyPatientsListModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class WardsClient {
    ...
    search(searchTerm: string | null | undefined): Observable<WardsListModel | null> {
    ...
    protected processSearch(response: HttpResponseBase): Observable<WardsListModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
