...
export class AmbulatoryAttentionRecordsClient {
    ...
    getAmbulatoryAttentionReportFile(searchTerm: string | null | undefined, filters: FilterSpec[] | null | undefined, sortInfo: SortSpec[] | null | undefined, pageIndex: number | undefined, pageSize: number | undefined): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/AmbulatoryAttentionRecords/at1-report/download?";
        if (searchTerm !== undefined)
            url_ += "SearchTerm=" + encodeURIComponent("" + searchTerm) + "&"; 
        if (filters !== undefined)
            filters && filters.forEach((item, index) => { 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAmbulatoryAttentionReportFile(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAmbulatoryAttentionReportFile(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse | null>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetAmbulatoryAttentionReportFile(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class BloodTransfusionsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(sortInfo: SortSpec[] | null | undefined, pageIndex: number | undefined, pageSize: number | undefined): Observable<ListModelOfBloodTransfusionModel | null> {
        let url_ = this.baseUrl + "/api/BloodTransfusions?";
        if (sortInfo !== undefined)
            sortInfo && sortInfo.forEach((item, index) => { 
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListModelOfBloodTransfusionModel | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListModelOfBloodTransfusionModel | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListModelOfBloodTransfusionModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListModelOfBloodTransfusionModel.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListModelOfBloodTransfusionModel | null>(<any>null);
    }

    createBloodTransfusion(model: BloodTransfusionModel): Observable<number> {
        let url_ = this.baseUrl + "/api/BloodTransfusions";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateBloodTransfusion(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateBloodTransfusion(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateBloodTransfusion(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    updateBloodTransfusion(model: BloodTransfusionModel): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/BloodTransfusions";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateBloodTransfusion(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateBloodTransfusion(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse | null>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateBloodTransfusion(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    search(searchTerm: string | null | undefined): Observable<ListModelOfBloodTransfusionModel | null> {
        let url_ = this.baseUrl + "/api/BloodTransfusions/search?";
        if (searchTerm !== undefined)
            url_ += "searchTerm=" + encodeURIComponent("" + searchTerm) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSearch(response: HttpResponseBase): Observable<ListModelOfBloodTransfusionModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getBloodTransfusion(id: number): Observable<BloodTransfusionModel | null> {
        let url_ = this.baseUrl + "/api/BloodTransfusions/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetBloodTransfusion(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetBloodTransfusion(<any>response_);
                } catch (e) {
                    return <Observable<BloodTransfusionModel | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<BloodTransfusionModel | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetBloodTransfusion(response: HttpResponseBase): Observable<BloodTransfusionModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? BloodTransfusionModel.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<BloodTransfusionModel | null>(<any>null);
    }
}
...
export class TransfusionPhasesClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(sortInfo: SortSpec[] | null | undefined, pageIndex: number | undefined, pageSize: number | undefined): Observable<ListModelOfTransfusionPhaseModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionPhases?";
        if (sortInfo !== undefined)
            sortInfo && sortInfo.forEach((item, index) => { 
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListModelOfTransfusionPhaseModel | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListModelOfTransfusionPhaseModel | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListModelOfTransfusionPhaseModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListModelOfTransfusionPhaseModel.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListModelOfTransfusionPhaseModel | null>(<any>null);
    }

    createTransfusionPhase(model: TransfusionPhaseModel): Observable<number> {
        let url_ = this.baseUrl + "/api/TransfusionPhases";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateTransfusionPhase(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateTransfusionPhase(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateTransfusionPhase(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    updateTransfusionPhase(model: TransfusionPhaseModel): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/TransfusionPhases";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateTransfusionPhase(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateTransfusionPhase(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse | null>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateTransfusionPhase(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    search(searchTerm: string | null | undefined): Observable<ListModelOfTransfusionPhaseModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionPhases/search?";
        if (searchTerm !== undefined)
            url_ += "searchTerm=" + encodeURIComponent("" + searchTerm) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSearch(response: HttpResponseBase): Observable<ListModelOfTransfusionPhaseModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getTransfusionPhase(id: number): Observable<TransfusionPhaseModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionPhases/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTransfusionPhase(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTransfusionPhase(<any>response_);
                } catch (e) {
                    return <Observable<TransfusionPhaseModel | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<TransfusionPhaseModel | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetTransfusionPhase(response: HttpResponseBase): Observable<TransfusionPhaseModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? TransfusionPhaseModel.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TransfusionPhaseModel | null>(<any>null);
    }
}
...
export class TransfusionProductDetailsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(sortInfo: SortSpec[] | null | undefined, pageIndex: number | undefined, pageSize: number | undefined): Observable<ListModelOfTransfusionProductDetailModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionProductDetails?";
        if (sortInfo !== undefined)
            sortInfo && sortInfo.forEach((item, index) => { 
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListModelOfTransfusionProductDetailModel | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListModelOfTransfusionProductDetailModel | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListModelOfTransfusionProductDetailModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListModelOfTransfusionProductDetailModel.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListModelOfTransfusionProductDetailModel | null>(<any>null);
    }

    createTransfusionProductDetail(model: TransfusionProductDetailModel): Observable<number> {
        let url_ = this.baseUrl + "/api/TransfusionProductDetails";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateTransfusionProductDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateTransfusionProductDetail(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateTransfusionProductDetail(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    updateTransfusionProductDetail(model: TransfusionProductDetailModel): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/TransfusionProductDetails";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateTransfusionProductDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateTransfusionProductDetail(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse | null>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateTransfusionProductDetail(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    search(searchTerm: string | null | undefined): Observable<ListModelOfTransfusionProductDetailModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionProductDetails/search?";
        if (searchTerm !== undefined)
            url_ += "searchTerm=" + encodeURIComponent("" + searchTerm) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSearch(response: HttpResponseBase): Observable<ListModelOfTransfusionProductDetailModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getTransfusionProductDetail(id: number): Observable<TransfusionProductDetailModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionProductDetails/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTransfusionProductDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTransfusionProductDetail(<any>response_);
                } catch (e) {
                    return <Observable<TransfusionProductDetailModel | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<TransfusionProductDetailModel | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetTransfusionProductDetail(response: HttpResponseBase): Observable<TransfusionProductDetailModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? TransfusionProductDetailModel.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TransfusionProductDetailModel | null>(<any>null);
    }
}
...
export class TransfusionVitalSignsDetailsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(sortInfo: SortSpec[] | null | undefined, pageIndex: number | undefined, pageSize: number | undefined): Observable<ListModelOfTransfusionVitalSignsDetailModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionVitalSignsDetails?";
        if (sortInfo !== undefined)
            sortInfo && sortInfo.forEach((item, index) => { 
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListModelOfTransfusionVitalSignsDetailModel | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListModelOfTransfusionVitalSignsDetailModel | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListModelOfTransfusionVitalSignsDetailModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListModelOfTransfusionVitalSignsDetailModel.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListModelOfTransfusionVitalSignsDetailModel | null>(<any>null);
    }

    createTransfusionVitalSignsDetail(model: TransfusionVitalSignsDetailModel): Observable<number> {
        let url_ = this.baseUrl + "/api/TransfusionVitalSignsDetails";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateTransfusionVitalSignsDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateTransfusionVitalSignsDetail(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateTransfusionVitalSignsDetail(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    updateTransfusionVitalSignsDetail(model: TransfusionVitalSignsDetailModel): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/TransfusionVitalSignsDetails";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateTransfusionVitalSignsDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateTransfusionVitalSignsDetail(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse | null>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateTransfusionVitalSignsDetail(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    search(searchTerm: string | null | undefined): Observable<ListModelOfTransfusionVitalSignsDetailModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionVitalSignsDetails/search?";
        if (searchTerm !== undefined)
            url_ += "searchTerm=" + encodeURIComponent("" + searchTerm) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processSearch(response: HttpResponseBase): Observable<ListModelOfTransfusionVitalSignsDetailModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getTransfusionVitalSignsDetail(id: number): Observable<TransfusionVitalSignsDetailModel | null> {
        let url_ = this.baseUrl + "/api/TransfusionVitalSignsDetails/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTransfusionVitalSignsDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTransfusionVitalSignsDetail(<any>response_);
                } catch (e) {
                    return <Observable<TransfusionVitalSignsDetailModel | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<TransfusionVitalSignsDetailModel | null>><any>_observableThrow(response_);
        }));
    }

    protected processGetTransfusionVitalSignsDetail(response: HttpResponseBase): Observable<TransfusionVitalSignsDetailModel | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? TransfusionVitalSignsDetailModel.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TransfusionVitalSignsDetailModel | null>(<any>null);
    }
}
...
export class ListModelOfBloodTransfusionModel implements IListModelOfBloodTransfusionModel {
    items?: BloodTransfusionModel[] | undefined;
    itemCount!: number;
    pageIndex!: number;
    totalCount!: number;
    totalPages!: number;
    ...
    constructor(data?: IListModelOfBloodTransfusionModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(BloodTransfusionModel.fromJS(item));
            }
            this.itemCount = data["itemCount"];
            this.pageIndex = data["pageIndex"];
            this.totalCount = data["totalCount"];
    ...
    static fromJS(data: any): ListModelOfBloodTransfusionModel {
        data = typeof data === 'object' ? data : {};
        let result = new ListModelOfBloodTransfusionModel();
        result.init(data);
        return result;
    }
...
export interface IListModelOfBloodTransfusionModel {
    items?: BloodTransfusionModel[] | undefined;
    itemCount: number;
    pageIndex: number;
    totalCount: number;
...
export class BloodTransfusionModel implements IBloodTransfusionModel {
    bloodTransfusionId?: number | undefined;
    oncologyPatientId?: number | undefined;
    wardId?: number | undefined;
    verifyBy?: string | undefined;
    date?: Date | undefined;
    group?: string | undefined;
    aborh?: string | undefined;
    wardName?: string | undefined;
    oncologyPatientFullName?: string | undefined;

    constructor(data?: IBloodTransfusionModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.bloodTransfusionId = data["bloodTransfusionId"];
            this.oncologyPatientId = data["oncologyPatientId"];
            this.wardId = data["wardId"];
            this.verifyBy = data["verifyBy"];
            this.date = data["date"] ? new Date(data["date"].toString()) : <any>undefined;
            this.group = data["group"];
            this.aborh = data["aborh"];
            this.wardName = data["wardName"];
            this.oncologyPatientFullName = data["oncologyPatientFullName"];
        }
    }

    static fromJS(data: any): BloodTransfusionModel {
        data = typeof data === 'object' ? data : {};
        let result = new BloodTransfusionModel();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["bloodTransfusionId"] = this.bloodTransfusionId;
        data["oncologyPatientId"] = this.oncologyPatientId;
        data["wardId"] = this.wardId;
        data["verifyBy"] = this.verifyBy;
        data["date"] = this.date ? this.date.toISOString() : <any>undefined;
        data["group"] = this.group;
        data["aborh"] = this.aborh;
        data["wardName"] = this.wardName;
        data["oncologyPatientFullName"] = this.oncologyPatientFullName;
        return data; 
    }
...
export interface IBloodTransfusionModel {
    bloodTransfusionId?: number | undefined;
    oncologyPatientId?: number | undefined;
    wardId?: number | undefined;
    verifyBy?: string | undefined;
...
export class ListModelOfTransfusionPhaseModel implements IListModelOfTransfusionPhaseModel {
    items?: TransfusionPhaseModel[] | undefined;
    itemCount!: number;
    pageIndex!: number;
    totalCount!: number;
    totalPages!: number;
    ...
    constructor(data?: IListModelOfTransfusionPhaseModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(TransfusionPhaseModel.fromJS(item));
            }
            this.itemCount = data["itemCount"];
            this.pageIndex = data["pageIndex"];
            this.totalCount = data["totalCount"];
    ...
    static fromJS(data: any): ListModelOfTransfusionPhaseModel {
        data = typeof data === 'object' ? data : {};
        let result = new ListModelOfTransfusionPhaseModel();
        result.init(data);
        return result;
    }
...
export interface IListModelOfTransfusionPhaseModel {
    items?: TransfusionPhaseModel[] | undefined;
    itemCount: number;
    pageIndex: number;
    totalCount: number;
...
export class TransfusionPhaseModel implements ITransfusionPhaseModel {
    transfusionPhaseId?: number | undefined;
    name?: string | undefined;

    constructor(data?: ITransfusionPhaseModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.transfusionPhaseId = data["transfusionPhaseId"];
            this.name = data["name"];
        }
    }

    static fromJS(data: any): TransfusionPhaseModel {
        data = typeof data === 'object' ? data : {};
        let result = new TransfusionPhaseModel();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["transfusionPhaseId"] = this.transfusionPhaseId;
        data["name"] = this.name;
        return data; 
    }
}

export interface ITransfusionPhaseModel {
    transfusionPhaseId?: number | undefined;
    name?: string | undefined;
}

export class ListModelOfTransfusionProductDetailModel implements IListModelOfTransfusionProductDetailModel {
    items?: TransfusionProductDetailModel[] | undefined;
    itemCount!: number;
    pageIndex!: number;
    totalCount!: number;
    totalPages!: number;
    ...
    constructor(data?: IListModelOfTransfusionProductDetailModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(TransfusionProductDetailModel.fromJS(item));
            }
            this.itemCount = data["itemCount"];
            this.pageIndex = data["pageIndex"];
            this.totalCount = data["totalCount"];
    ...
    static fromJS(data: any): ListModelOfTransfusionProductDetailModel {
        data = typeof data === 'object' ? data : {};
        let result = new ListModelOfTransfusionProductDetailModel();
        result.init(data);
        return result;
    }
...
export interface IListModelOfTransfusionProductDetailModel {
    items?: TransfusionProductDetailModel[] | undefined;
    itemCount: number;
    pageIndex: number;
    totalCount: number;
...
export class TransfusionProductDetailModel implements ITransfusionProductDetailModel {
    transfusionProductDetailId?: number | undefined;
    bloodTransfusionId?: number | undefined;
    ...
    constructor(data?: ITransfusionProductDetailModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.transfusionProductDetailId = data["transfusionProductDetailId"];
            this.bloodTransfusionId = data["bloodTransfusionId"];
            ...
            this.adverseReactions = data["adverseReactions"];
        }
    }

    static fromJS(data: any): TransfusionProductDetailModel {
        data = typeof data === 'object' ? data : {};
        let result = new TransfusionProductDetailModel();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["transfusionProductDetailId"] = this.transfusionProductDetailId;
        data["bloodTransfusionId"] = this.bloodTransfusionId;
        ...
        data["adverseReactions"] = this.adverseReactions;
        return data; 
    }
}

export interface ITransfusionProductDetailModel {
    transfusionProductDetailId?: number | undefined;
    bloodTransfusionId?: number | undefined;
    unitNumber?: string | undefined;
    component?: string | undefined;
...
export class ListModelOfTransfusionVitalSignsDetailModel implements IListModelOfTransfusionVitalSignsDetailModel {
    items?: TransfusionVitalSignsDetailModel[] | undefined;
    itemCount!: number;
    pageIndex!: number;
    totalCount!: number;
    totalPages!: number;
    ...
    constructor(data?: IListModelOfTransfusionVitalSignsDetailModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(TransfusionVitalSignsDetailModel.fromJS(item));
            }
            this.itemCount = data["itemCount"];
            this.pageIndex = data["pageIndex"];
            this.totalCount = data["totalCount"];
    ...
    static fromJS(data: any): ListModelOfTransfusionVitalSignsDetailModel {
        data = typeof data === 'object' ? data : {};
        let result = new ListModelOfTransfusionVitalSignsDetailModel();
        result.init(data);
        return result;
    }
...
export interface IListModelOfTransfusionVitalSignsDetailModel {
    items?: TransfusionVitalSignsDetailModel[] | undefined;
    itemCount: number;
    pageIndex: number;
    totalCount: number;
...
export class TransfusionVitalSignsDetailModel implements ITransfusionVitalSignsDetailModel {
    transfusionVitalSignsDetailId?: number | undefined;
    bloodTransfusionId?: number | undefined;
    transfusionPhaseId?: number | undefined;
    arterialPressure?: number | undefined;
    temperatureC?: number | undefined;
    heartbeatRateBpm?: number | undefined;
    respiratoryFrequence?: number | undefined;
    responsible?: string | undefined;
    observations?: string | undefined;
    transfusionPhaseName?: string | undefined;

    constructor(data?: ITransfusionVitalSignsDetailModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.transfusionVitalSignsDetailId = data["transfusionVitalSignsDetailId"];
            this.bloodTransfusionId = data["bloodTransfusionId"];
            this.transfusionPhaseId = data["transfusionPhaseId"];
            this.arterialPressure = data["arterialPressure"];
            this.temperatureC = data["temperatureC"];
            this.heartbeatRateBpm = data["heartbeatRateBpm"];
            this.respiratoryFrequence = data["respiratoryFrequence"];
            this.responsible = data["responsible"];
            this.observations = data["observations"];
            this.transfusionPhaseName = data["transfusionPhaseName"];
        }
    }

    static fromJS(data: any): TransfusionVitalSignsDetailModel {
        data = typeof data === 'object' ? data : {};
        let result = new TransfusionVitalSignsDetailModel();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["transfusionVitalSignsDetailId"] = this.transfusionVitalSignsDetailId;
        data["bloodTransfusionId"] = this.bloodTransfusionId;
        data["transfusionPhaseId"] = this.transfusionPhaseId;
        data["arterialPressure"] = this.arterialPressure;
        data["temperatureC"] = this.temperatureC;
        data["heartbeatRateBpm"] = this.heartbeatRateBpm;
        data["respiratoryFrequence"] = this.respiratoryFrequence;
        data["responsible"] = this.responsible;
        data["observations"] = this.observations;
        data["transfusionPhaseName"] = this.transfusionPhaseName;
        return data; 
    }
}

export interface ITransfusionVitalSignsDetailModel {
    transfusionVitalSignsDetailId?: number | undefined;
    bloodTransfusionId?: number | undefined;
    transfusionPhaseId?: number | undefined;
    arterialPressure?: number | undefined;
