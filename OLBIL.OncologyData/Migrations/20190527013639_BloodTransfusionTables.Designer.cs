...
namespace OLBIL.OncologyData.Migrations
{
    ...
    [Migration("20190527013639_BloodTransfusionTables")]
    partial class BloodTransfusionTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OLBIL.OncologyDomain.Entities.BloodTransfusion", b =>
                {
                    b.Property<int>("BloodTransfusionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("bloodtransfusionid");

                    b.Property<string>("ABORH")
                        .HasColumnName("aborh");
            ...
            modelBuilder.Entity("OLBIL.OncologyDomain.Entities.TransfusionPhase", b =>
                {
                    b.Property<int>("TransfusionPhaseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("transfusionphaseid");

                    b.Property<string>("Name")
                        .HasColumnName("name");

                    b.HasKey("TransfusionPhaseId");

                    b.ToTable("transfusionphase");
                });

            modelBuilder.Entity("OLBIL.OncologyDomain.Entities.TransfusionProductDetail", b =>
                {
                    b.Property<int>("TransfusionProductDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("transfusionproductdetailid");
                    ...
                    b.HasKey("TransfusionProductDetailId");

                    b.HasIndex("BloodTransfusionId");

                    b.ToTable("transfusionproductdetail");
                });

            modelBuilder.Entity("OLBIL.OncologyDomain.Entities.TransfusionVitalSignsDetail", b =>
                {
                    b.Property<int>("TransfusionVitalSignsDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("transfusionvitalsignsdetailid");

                    b.Property<decimal>("ArterialPressure")
                        .HasColumnName("arterialpressure");

                    b.Property<int>("BloodTransfusionId")
                        .HasColumnName("bloodtransfusionid");

                    b.Property<decimal>("HeartbeatRateBpm")
                        .HasColumnName("heartbeatratebpm");

                    b.Property<string>("Observations")
                        .HasColumnName("observations");

                    b.Property<decimal>("RespiratoryFrequence")
                        .HasColumnName("respiratoryfrequence");
                    ...
                    b.HasKey("TransfusionVitalSignsDetailId");

                    b.HasIndex("BloodTransfusionId");

                    b.HasIndex("TransfusionPhaseId");

                    b.ToTable("transfusionvitalsignsdetail");
                });
            ...
            modelBuilder.Entity("OLBIL.OncologyDomain.Entities.TransfusionProductDetail", b =>
                {
                    b.HasOne("OLBIL.OncologyDomain.Entities.BloodTransfusion", "BloodTransfusion")
                        .WithMany("TransfusionProductDetails")
            ...
            modelBuilder.Entity("OLBIL.OncologyDomain.Entities.TransfusionVitalSignsDetail", b =>
                {
                    b.HasOne("OLBIL.OncologyDomain.Entities.BloodTransfusion", "BloodTransfusion")
                        .WithMany("TransfusionVitalSignsDetails")
                        .HasForeignKey("BloodTransfusionId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("OLBIL.OncologyDomain.Entities.TransfusionPhase", "TransfusionPhase")
                        .WithMany()
                        .HasForeignKey("TransfusionPhaseId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
