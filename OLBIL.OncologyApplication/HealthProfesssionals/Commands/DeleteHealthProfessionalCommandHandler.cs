...
{
    public class DeleteHealthProfessionalCommandHandler : IRequestHandler<DeleteHealthProfessionalCommand>
    {
        private readonly OncologyContext _context;
        private readonly IMapper _mapper;

        public DeleteHealthProfessionalCommandHandler(OncologyContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
