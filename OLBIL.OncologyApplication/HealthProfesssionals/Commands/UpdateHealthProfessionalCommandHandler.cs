...
{
    public class UpdateHealthProfessionalCommandHandler : IRequestHandler<UpdateHealthProfessionalCommand>
    {
        private readonly OncologyContext _context;
        private readonly IMapper _mapper;

        public UpdateHealthProfessionalCommandHandler(OncologyContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
